                      ...
                      if (snapshot.hasData) {
                        ...
                        return NotesListView(
                          ...
                          onDeleteNote: (note) async {
                            await NotesService().deleteNote(noteId: note.id);
                          },
                          onTap: (note) {
